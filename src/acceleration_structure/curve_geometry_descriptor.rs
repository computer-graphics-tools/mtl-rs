...
impl MTLAccelerationStructureCurveGeometryDescriptor {
    extern_methods!(
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn control_point_stride(&self) -> usize;

        /// Setter for [`controlPointStride`][Self::controlPointStride].
        #[unsafe(method(setControlPointStride:))]
        #[unsafe(method_family = none)]
        pub unsafe fn set_control_point_stride(&self, control_point_stride: usize);
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn radius_buffer_offset(&self) -> usize;

        /// Setter for [`radiusBufferOffset`][Self::radiusBufferOffset].
        #[unsafe(method(setRadiusBufferOffset:))]
        #[unsafe(method_family = none)]
        pub unsafe fn set_radius_buffer_offset(&self, radius_buffer_offset: usize);
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn radius_stride(&self) -> usize;

        /// Setter for [`radiusStride`][Self::radiusStride].
        #[unsafe(method(setRadiusStride:))]
        #[unsafe(method_family = none)]
        pub unsafe fn set_radius_stride(&self, radius_stride: usize);
