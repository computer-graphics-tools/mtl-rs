...
impl MTLNewLibraryCompletionHandler {
    ...
    pub fn copy(
        ptr: *mut DynBlock<dyn Fn(*mut ProtocolObject<dyn MTLLibrary>, *mut NSError)>,
    ) -> Self {
...
impl MTLNewComputePipelineStateCompletionHandler {
    ...
    {
        Self(RcBlock::new(
            move |pipeline_ptr: *mut ProtocolObject<dyn MTLComputePipelineState>,
                  error: *mut NSError| {
...
impl MTLNewRenderPipelineStateCompletionHandler {
    ...
    {
        Self(RcBlock::new(
            move |pipeline_ptr: *mut ProtocolObject<dyn MTLRenderPipelineState>,
                  error: *mut NSError| {
                let pipeline = unsafe { Retained::from_raw(pipeline_ptr) };
                handler(pipeline, error);
            },
...
impl MTL4NewBinaryFunctionCompletionHandler {
    ...
    {
        Self(RcBlock::new(
            move |binary_fn_ptr: *mut ProtocolObject<dyn MTL4BinaryFunction>,
                  error: *mut NSError| {
...
impl MTL4NewMachineLearningPipelineStateCompletionHandler {
    pub fn new<F>(handler: F) -> Self
    where
        F: Fn(Option<Retained<ProtocolObject<dyn MTL4MachineLearningPipelineState>>>, *mut NSError)
            + 'static,
    {
        Self(RcBlock::new(
