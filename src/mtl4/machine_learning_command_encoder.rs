...
extern_protocol!(
    ...
    pub unsafe trait MTL4MachineLearningCommandEncoder: MTL4CommandEncoder {
        ...
        #[unsafe(method_family = none)]
        unsafe fn set_argument_table(&self, argument_table: &ProtocolObject<dyn MTL4ArgumentTable>);
        ...
        #[unsafe(method_family = none)]
        unsafe fn dispatch_network_with_intermediates_heap(&self, heap: &ProtocolObject<dyn MTLHeap>);
    }
);
