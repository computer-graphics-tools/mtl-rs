...
use super::{
    MTLCullMode, MTLDepthClipMode, MTLScissorRect, MTLTriangleFillMode, MTLViewport,
    MTLVisibilityResultMode,
};
use crate::depth_stencil::MTLDepthStencilState;
use crate::render_pipeline::{MTLLogicalToPhysicalColorAttachmentMap, MTLRenderPipelineState};
use crate::{MTLBuffer, MTLCommandEncoder, MTLPrimitiveType, MTLTexture};
...
extern_protocol!(
    ...
    pub unsafe trait MTLRenderCommandEncoder: MTLCommandEncoder {
        ...
        #[unsafe(method_family = none)]
        fn set_vertex_bytes(&self, bytes: NonNull<core::ffi::c_void>, length: usize, index: usize);
