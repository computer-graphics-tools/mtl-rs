...
Use an MTLTextureDescriptor object to configure properties like texture dimensions and pixel format for an MTLTexture object. Then call the newTextureWithDescriptor: method to create a texture.
