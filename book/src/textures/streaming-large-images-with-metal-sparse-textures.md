...
The sample checks if the MTLGPUFamilyApple6 feature set is available with the supportsFamily: method. This feature set begins with the Apple A13 GPUs. Here’s the code from AAPLViewController:viewDidLoad:
