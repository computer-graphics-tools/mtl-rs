...
> [Apple Documentation](https://developer.apple.com/documentation/metal/rendering-a-scene-with-deferred-lighting-in-swift?language=objc)
...
```bash
cargo run --example rendering_a_scene_with_deferred_lighting_in_swift
```
...
- `Documentation/deferred-lighting-swift-9-StencilMaskOnly.png`
- `Documentation/deferred-lighting-swift-7-ShadowMap.png`
- `Documentation/deferred-lighting-swift-6-DeferredLightingWithRasterOrderGroups.png`
- `Documentation/deferred-lighting-swift-10-StencilMaskVSFullVolumes.png`
- `Documentation/deferred-lighting-swift-4-SinglePassDeferredLightingOnTBDR.png`
- `Documentation/deferred-lighting-swift-8-GBufferTextures.png`
- `Documentation/deferred-lighting-swift-2-TraditionalDeferredLighting.png`
- `Documentation/deferred-lighting-swift-1-DeferredLighting.png`
- `Documentation/deferred-lighting-swift-3-TraditionalDeferredLightingOnTBDR.png`
- `Documentation/deferred-lighting-swift-5-DeferredLightingWithoutRasterOrderGroups.png`
