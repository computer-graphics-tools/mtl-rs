...
Metal clears the interoperable texture by applying a green color.

Metal renders a quad with white text and color swatch onto the interoperable texture.

OpenGL clears the background by applying a red color.

OpenGL renders a quad with black text and the interoperable texture.
...
OpenGL clears the interoperable texture by applying a red color.

OpenGL renders a quad with white text and color swatch onto the interoperable texture.

Metal clears the background by applying a green color.

Metal renders a quad with black text and the interoperable texture.
